...
@Composable
@Suppress("UNUSED_PARAMETER") // Back handled by top bar; keep for API symmetry with other screens
fun MessageFilterSearchScreen(
    onBack: () -> Unit,
    viewModel: MessageFilterSearchViewModel = hiltViewModel()
) {
